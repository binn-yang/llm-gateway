<template>
  <div class="chart-panel">
    <div class="panel-header">
      <h3 class="panel-title">TOKEN USAGE BY INSTANCE</h3>
...
async function fetchData() {
  ...
  try {
    ...
    console.error('Failed to fetch token usage by instance:', error)
  } finally {
...
function updateChart(data: TimeseriesDataPoint[]) {
  ...
  const datasets = groupDataByInstance(data)

  // Extract unique timestamps and convert from UTC to local time
...
function groupDataByInstance(data: TimeseriesDataPoint[]) {
